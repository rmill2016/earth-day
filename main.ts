...
game.splash("Lets Help Clean up our Planet!")
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
game.showLongText("This is our Earth!", DialogLayout.Bottom)
game.showLongText("We Have to work together to keep it clean", DialogLayout.Bottom)
scene.setBackgroundImage(img`
...
mySprite.sayText("Help move me around to pick up the trash", 5000, true)
info.setScore(0)
    ...
    for (let index = 0; index < randint(1, 5); index++) {
        if (Math.percentChance(33)) {
            Trash = sprites.create(img`
                ...
                . . . . . . . . . . . . . . . . 
                `, SpriteKind.Food)
            Trash.setPosition(randint(5, 160), randint(80, 115))
            ...
            Trash = sprites.create(img`
                ...
                . . c c c c . . 
                `, SpriteKind.Food)
            Trash.setPosition(randint(0, 160), randint(80, 115))
        } else if (Math.percentChance(33)) {
            Trash = sprites.create(img`
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                ...
                . . . . f 1 1 1 1 1 1 1 f . . . 
                . . . . f 6 6 1 1 1 1 6 1 . . . 
                . . . f 1 6 1 1 1 1 6 1 1 2 . . 
                . . . f 6 1 1 1 1 6 f f f 2 . . 
                . . . . . . 2 6 f f f . . . . . 
                `, SpriteKind.Food)
            Trash.setPosition(randint(0, 160), randint(80, 115))
        }
